...
export default function LandingPage() {
    ...
    return (
        ...
        <div className="absolute inset-0 bg-linear-to-r from-black/95 via-black/80 to-transparent"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center h-full w-full md:w-1/2 px-10 md:px-20 py-16 text-left space-y-8 animate-fadeInSlow">
            ...
            <span className="absolute inset-0 bg-[#003153] -z-10 translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>

            {/* Button text */}
            <Link href={href} className="relative z-10 transition-colors duration-300">
                Get Started
            </Link>
        </button>
        </div>
