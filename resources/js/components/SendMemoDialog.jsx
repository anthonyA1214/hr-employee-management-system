    ...
    return (
        <Dialog>
            <Form>
                ...
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle className="text-2xl">Send New Memo</DialogTitle>
                    ...
                    <div className="flex flex-col gap-y-2">
                        ...
                        <Input id="memo_subject" type="text" placeholder="Enter memo subject" required />
                    </div>

                    <div className="flex flex-col gap-y-2">
                        <Label htmlFor="memo_body">Memo Body</Label>
                        <Textarea id="memo_body" placeholder="Enter memo body" required />
                    </div>
                    <DialogFooter>
                        <DialogClose asChild>
                            <Button variant="outline">Cancel</Button>
                        </DialogClose>
                        <Button type="submit" className="bg-[#018CEF] hover:bg-[#30A1EF] active:bg-[#5DB1EB]">Send Memo</Button>
                    </DialogFooter>
                </DialogContent>
            </Form>
        </Dialog>
