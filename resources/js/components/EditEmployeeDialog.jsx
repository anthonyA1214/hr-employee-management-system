                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <Input id="contact_number" type="tel" placeholder="09123456789" value={data.contact_number} onChange={(e) => setData('contact_number', e.target.value)} required />
                            {errors.contact_number && (<span className="text-sm text-red-500">{errors.contact_number}</span>)}
                        </div>

                        {/* Position */}
                        <div className="flex flex-col gap-y-2">
                            <Label htmlFor="position">Position</Label>
                            <Input id="position" type="text" placeholder="Admin" value={data.position} onChange={(e) => setData('position', e.target.value)} required />
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <Input id="department" type="text" placeholder="HR Department" value={data.department} onChange={(e) => setData('department', e.target.value)} required />
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <Input id="hired_at" type="date" value={data.hired_at} onChange={(e) => setData('hired_at', e.target.value)} required />
                            {errors.hired_at && (<span className="text-sm text-red-500">{errors.hired_at}</span>)}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-2">
                        ...
                        <Input id="address" type="text" placeholder="Caloocan City, Philippines" value={data.address} onChange={(e) => setData('address', e.target.value)} required />
